...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python resnet50_extractor.py --dir /path/to/images/
  python resnet50_extractor.py --dir /path/to/images/ --out /path/to/output.csv
        """
    )
    ...
    if args.out is None:
        ...
        args.out = str(results_dir / f"ResNet50_{timestamp}.csv")
    ...
    try:
        ...
        for batch_idx in range(total_batches):
            ...
            if features:
                ...
                write_features_to_csv(args.out, features, successful_filenames, mode=mode)
